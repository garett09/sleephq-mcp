...
class DeviceEventServiceTest {
    ...
    @BeforeEach
    void setUp() {
        ClinicalContextProperties clinical = new ClinicalContextProperties("team-123", "cpap-1", "o2-1");
        deviceEventService = new DeviceEventService(sleepHqClient, s3RestClient, clinical);
    }
