...
public class AnalysisPrompts {
    ...
    public McpSchema.GetPromptResult nightlyReview(
        ...
        return factory.build("nightly-review", "Nightly review", Map.of("date", date));
    }
    ...
    public McpSchema.GetPromptResult centralApneaInvestigation(
            @McpArg(name = "date", description = "Night date YYYY-MM-DD", required = true) String date) {
        return factory.build("central-apnea-investigation", "Central apnea investigation", Map.of("date", date));
    }
    ...
    public McpSchema.GetPromptResult weeklyTrend(
            @McpArg(name = "weekStartDate", description = "Monday of the week YYYY-MM-DD", required = true) String weekStartDate) {
        return factory.build("weekly-trend", "Weekly trend", Map.of("weekStartDate", weekStartDate));
    }
    ...
    public McpSchema.GetPromptResult leakDiagnosis(
            @McpArg(name = "date", description = "Night date YYYY-MM-DD", required = true) String date) {
        return factory.build("leak-diagnosis", "Leak diagnosis", Map.of("date", date));
    }
    ...
    public McpSchema.GetPromptResult titrationDecision(
            @McpArg(name = "date", description = "Night date YYYY-MM-DD", required = true) String date) {
        return factory.build("titration-decision", "Titration decision", Map.of("date", date));
    }
    ...
    public McpSchema.GetPromptResult o2DesatReview(
            @McpArg(name = "date", description = "Night date YYYY-MM-DD", required = true) String date) {
        return factory.build("o2-desat-review", "O2 desat review", Map.of("date", date));
    }
